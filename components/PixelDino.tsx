      ...
      case 'VELOCIRAPTOR':
        return (
          <svg {...svgProps}>
            ...
            {/* Textura escamas dorso */}
            <rect x="5" y="15" width="1" height="1" fill="#6b8c42" />
            <rect x="8" y="15" width="1" height="1" fill="#6b8c42" />
            {/* Corpo */}
            <rect x="12" y="17" width="10" height="7" fill="#6b8c42" />
            <rect x="14" y="17" width="8" height="2" fill="#4d6331" />
            <rect x="13" y="19" width="8" height="5" fill="#c28151" />
            <rect x="14" y="22" width="6" height="1" fill="#e5aa70" /> {/* Brilho ventre */}
            {/* Pernas e Garra Assassina */}
            <rect x="14" y="24" width="3" height="4" fill="#3a4d25" />
            <rect x="13" y="27" width="2" height="1" fill="#000" />
            ...
            <rect x="25" y="14" width="5" height="1" fill="#1a1a1a" />
            <rect x="25" y="11" width="1" height="1" fill="#ffec00" />
            <rect x="26" y="11" width="1" height="1" fill="#000" />
            <rect x="23" y="11" width="1" height="1" fill="#ffffff" opacity="0.3" /> {/* Brilho olho */}
          </svg>
        );
      case 'TREX':
        return (
          <svg {...svgProps}>
            ...
            <rect x="4" y="22" width="2" height="1" fill="#c0392b" /> {/* Detalhe cauda */}
            {/* Corpo e Ventre */}
            <rect x="10" y="15" width="14" height="12" fill="#c0392b" />
            <rect x="12" y="17" width="10" height="10" fill="#e74c3c" />
            <rect x="13" y="22" width="6" height="5" fill="#edbb99" />
            <rect x="14" y="24" width="3" height="2" fill="#f5d3b3" /> {/* Brilho ventre */}
            {/* Pernas Potentes */}
            <rect x="11" y="27" width="5" height="4" fill="#7a2319" />
            <rect x="19" y="27" width="5" height="4" fill="#7a2319" />
            <rect x="12" y="28" width="2" height="2" fill="#912a1e" /> {/* Músculo perna */}
            <rect x="11" y="30" width="2" height="1" fill="#1a1a1a" />
            ...
            <rect x="19" y="5" width="4" height="2" fill="#7a2319" /> {/* Sobrancelha */}
            <rect x="21" y="12" width="9" height="1" fill="#1a1a1a" />
            <rect x="22" y="13" width="1" height="1" fill="#fff" />
            <rect x="25" y="13" width="1" height="1" fill="#fff" />
            <rect x="28" y="13" width="1" height="1" fill="#fff" />
            <rect x="24" y="7" width="2" height="2" fill="#edbb99" />
            <rect x="25" y="7" width="1" height="1" fill="#000" />
            {/* Braços */}
      ...
      case 'TRICERATOPS':
        return (
          <svg {...svgProps}>
            ...
            <rect x="16" y="17" width="4" height="2" fill="#5dade2" />
            <rect x="22" y="19" width="1" height="1" fill="#21618c" /> {/* Mancha pele */}
            {/* Patas de Elefante */}
            <rect x="12" y="27" width="5" height="4" fill="#1a5276" />
            <rect x="23" y="27" width="5" height="4" fill="#1a5276" />
            <rect x="13" y="30" width="1" height="1" fill="#ffffff" opacity="0.4" /> {/* Unha */}
            {/* Gola/Escudo Detalhado */}
            <rect x="6" y="6" width="12" height="14" fill="#21618c" />
            <rect x="7" y="7" width="4" height="4" fill="#5dade2" opacity="0.3" /> {/* Padrão olho gola */}
            <rect x="13" y="12" width="4" height="4" fill="#5dade2" opacity="0.3" />
            {/* Cabeça e Chifres com Gradiente */}
            <rect x="2" y="15" width="10" height="8" fill="#3498db" />
            <rect x="0" y="17" width="3" height="3" fill="#d5dbdb" />
            <rect x="0" y="13" width="4" height="2" fill="#f4f6f7" />
            <rect x="3" y="5" width="2" height="10" fill="#f4f6f7" />
            <rect x="3" y="5" width="2" height="3" fill="#bdc3c7" />
            <rect x="9" y="5" width="2" height="10" fill="#f4f6f7" />
      ...
      case 'PTERODACTYL':
        return (
          <svg {...svgProps}>
            ...
            <rect x="6" y="12" width="1" height="4" fill="#5b2c6f" />
            <rect x="25" y="12" width="1" height="4" fill="#5b2c6f" />
            <rect x="10" y="11" width="1" height="2" fill="#ffffff" opacity="0.2" /> {/* Brilho asa */}
            {/* Corpo e Crista */}
            <rect x="14" y="8" width="4" height="14" fill="#7d3c98" />
            <rect x="14" y="4" width="6" height="5" fill="#9b59b6" />
            <rect x="12" y="0" width="2" height="8" fill="#e74c3c" />
            <rect x="12" y="1" width="2" height="2" fill="#f39c12" /> {/* Brilho crista */}
            {/* Cabeça e Bico */}
            <rect x="20" y="6" width="10" height="2" fill="#f1c40f" />
            <rect x="28" y="6" width="2" height="2" fill="#e67e22" /> {/* Ponta bico */}
      ...
      case 'STEGOSAURUS':
        return (
          <svg {...svgProps}>
            ...
            <rect x="10" y="19" width="2" height="2" fill="#b7950b" />
            <rect x="18" y="21" width="2" height="2" fill="#b7950b" />
            <rect x="12" y="17" width="3" height="1" fill="#ffffff" opacity="0.3" /> {/* Brilho pele */}
            {/* Placas Dorsais de 3 Cores */}
            <rect x="7" y="10" width="5" height="5" fill="#7b241c" />
            <rect x="8" y="11" width="3" height="3" fill="#c0392b" />
            <rect x="9" y="11" width="1" height="1" fill="#e74c3c" /> {/* Brilho placa */}
            ...
            <rect x="0" y="15" width="1" height="1" fill="#bdc3c7" />
